...
import dobi from "../assets/dobi.png";
...
const nutrientList_digestion = [
      {id:6, name: "락토핏 골드 2g x 50포", company: "종근당", pics: imgs.Img10,
    comment:"Test",
    ...
    , {id:7, name: "뉴네이처 바이탈 프리미엄 프로바이오틱스 유산균 500mg x 60캡슐", company: "뉴네이처", pics: imgs.Img6,
    comment:"Test",
    ...
    , {id:8, name: "덴프스 덴마크 유산균이야기 LGG유산균 2박스 / 총 4 개월분", company: "덴프스", pics: imgs.Img9,
    comment:"Test",
    ...
    , {id:9, name: "GNM자연의품격 100억 프로바이오틱스 500mg x 60캡슐", company: "GNM자연의품격", pics: imgs.Img8,
    comment:"Test",
    ...
    , {id:10, name: "다이어트 유산균 비에날씬 450mg x 60캡슐", company: "비에날씬", pics: imgs.Img7,
    comment:"Test",
...
const nutrientList_liver = [
      {id:11, name: "해나우푸드 실리마린 밀크씨슬 300mg x 200캡슐", company: "해나우푸드", pics: imgs.Img14,
    comment:"Test",
    ...
    , {id:12, name: "락티브 간에 좋은 유기농 밀크씨슬 실리마린 500mg x 60정", company: "락티브", pics: imgs.Img13,
    comment:"Test",
    ...
    , {id:13, name: "고려은단 퓨어 밀크씨슬 500mg x 60캡슐", company: "고려은단", pics: imgs.Img12,
    comment:"Test",
    ...
    , {id:14, name: "뉴트리코어 유기농 밀크씨슬 1000mg x 30정", company: "뉴트리코어", pics: imgs.Img11,
    comment:"Test",
...
const nutrientList_eye = [
    ...
    , {id:17, name: "아이클리어 루테인아스타잔틴", company: "종근당건강", pics: imgs.Img18,
    ...
    , {id:18, name: "루테인 지아잔틴 164 알티지오메가3", company: "뉴트리원", pics: imgs.Img17,
    ...
    , {id:20, name: "퓨어 rTG DHA 오메가3 식물성캡슐", company: "고려은단", pics: imgs.Img24,
...
const nutrientList_bone = [
      {id:21, name: "닥터에스더 어골칼슘 프리미엄", company: "에스더 포뮬라", pics: imgs.Img20,
    ...
    , {id:22, name: "칼슘앤 마그네슘 비타민D", company: "종근당건강", pics: imgs.Img21,
    comment:"1일 1회, 1회 2정",
    ...
    , {id:23, name: "뉴트리코어 칼슘마그네슘디", company: "뉴트리코어", pics: imgs.Img22,
    comment:"1일 1회, 1회 3정",
    shoplink:"https://www.nutricore.co.kr/goods/view?no=95"}
    , {id:24, name: "쁘띠앤 국민 칼마디", company: "쁘띠앤", pics: imgs.Img25,
    comment:"1일 1회, 1회 2정",
    shoplink:"https://www.apharmhealth.co.kr/product/쁘띠앤-국민-칼마디-1개월/59/category/42/display/1/"}
    , {id:25, name: "닥터아돌 칼슘마그네슘비타민D+", company: "닥터아돌", pics: imgs.Img23,
    comment:"1일 1회, 1회 2정",
...
const NutrientsData = ({ type }) => {
    ...
    if (type === "1") {
        targetData = nutrientList_vigor;
        h1Cont = "피로/활력";
        pCont = "피로 / 활력 고민엔 비타민 어떨까요?"
    }
    else if (type === "2") {
        targetData = nutrientList_digestion;
        h1Cont = "소화";
        pCont = "소화 고민엔 유산균 어떨까요?"
    }
    else if (type === "3") {
        targetData = nutrientList_liver;
        h1Cont = "간 건강";
        pCont = "간 건강엔 밀크씨슬 어떨까요?"
    }
    else if (type === "4") {
        targetData = nutrientList_eye;
        h1Cont = "눈 건강";
        pCont = "눈 건강엔 루테인 어떨까요?"
    }
    else if (type === "5") {
        targetData = nutrientList_bone;
        h1Cont = "뼈 건강";
        pCont = "뼈 건강엔 칼슘 어떨까요?"
    }
    else if (type === "6") {
        targetData = nutrientList_etc;
        h1Cont = "기타";
